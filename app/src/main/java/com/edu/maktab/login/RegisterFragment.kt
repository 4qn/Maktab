...
class RegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            ...
            .requestEmail()
            .build()
       var ss = SpannableString(getString(R.string.account_login_text))

binding.textView.text = getString(R.string.account_login_text)
        binding.textLogin.text = getString(R.string.login)
